...
//==========================================================================
typedef enum {
	PUSHPULL_OUTPUT = 0,				//		(0x00UL)
	OPENDRAIN_OUTPUT = 1,				//		(0x01UL)
	LOGIC_INPUT = 2,					//		(0x02UL)
	ANALOG_INPUT = 3					//		(0x03UL)
} PORT_Type;

#define PCU_CR_MASK						    	(0x03UL)
...
// void PCU_SetDirection (PCU_Type * PCUx, uint32_t pin_no, uint32_t dir_type);
// //void PCU_ConfigurePullup (PCU_Type * PCUx, uint32_t pin_no, uint32_t pullup);
// void PCU_ConfigurePullupdown (PCU_Type * PCUx, uint32_t pin_no, uint32_t mode);


void PCU_ConfigureFunction (PCU_Type * PCUx, uint32_t pin_no, uint32_t func);
void PCU_SetDirection (PCU_Type * PCUx, uint32_t pin_no, PORT_Type dir_type);
//void PCU_ConfigurePullup (PCU_Type * PCUx, uint32_t pin_no, uint32_t pullup);
void PCU_ConfigurePullupdown (PCU_Type * PCUx, uint32_t pin_no, PUPD_Type mode);
