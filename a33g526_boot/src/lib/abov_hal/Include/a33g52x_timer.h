...
//
//==========================================================================
#define TIMER_GET_TnCON(timer)			((timer)->TnCON)
#define TIMER_SET_TnCON(timer, val)		((timer)->TnCON = (val))
//-----------------------------------------------------------------------------------------
#define TIMER_GET_TnCMD(timer)			((timer)->TnCMD)
#define TIMER_SET_TnCMD(timer, val)		((timer)->TnCMD = (val))
//-----------------------------------------------------------------------------------------
#define TIMER_GET_TnGRA(timer)			((timer)->TnGRA)
#define TIMER_SET_TnGRA(timer, val)		((timer)->TnGRA = (val))
//-----------------------------------------------------------------------------------------
#define TIMER_GET_TnGRB(timer)			((timer)->TnGRB)
#define TIMER_SET_TnGRB(timer, val)		((timer)->TnGRB = (val))
//-----------------------------------------------------------------------------------------
#define TIMER_GET_TnPRS(timer)			((timer)->TnPRS)
#define TIMER_SET_TnPRS(timer, val)		((timer)->TnPRS = (val))
//-----------------------------------------------------------------------------------------
#define TIMER_GET_TnCNT(timer)			((timer)->TnCNT)
#define TIMER_SET_TnCNT(timer, val)		((timer)->TnCNT = (val))
