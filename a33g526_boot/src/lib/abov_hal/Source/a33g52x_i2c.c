...
void I2C_ConfigureGPIO (I2C_Type * const i2c)
{
	...
	PCU_SetDirection (scl_port_addr, scl_pin_no, OPENDRAIN_OUTPUT);
	PCU_SetDirection (sda_port_addr, sda_pin_no, OPENDRAIN_OUTPUT);

	PCU_ConfigurePullupdown(scl_port_addr, scl_pin_no, PUPD_DISABLE);
	PCU_ConfigurePullupdown(sda_port_addr, sda_pin_no, PUPD_DISABLE);
