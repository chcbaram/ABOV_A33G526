...
void PWM_ConfigureGPIO (PWM_Type * const pwm)
{
	...
	PCU_SetDirection(pwm_a_port_addr, pwm_a_pin_no, PUSHPULL_OUTPUT);
	PCU_ConfigurePullupdown (pwm_a_port_addr, pwm_a_pin_no, PUPD_DISABLE);

	PCU_ConfigureFunction (pwm_b_port_addr, pwm_b_pin_no, pwm_b_mux_info);
	PCU_SetDirection(pwm_b_port_addr, pwm_b_pin_no, PUSHPULL_OUTPUT);
	PCU_ConfigurePullupdown (pwm_b_port_addr, pwm_b_pin_no, PUPD_DISABLE);
